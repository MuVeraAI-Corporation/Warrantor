...
```
source_identity, acquisition_time, consent, sensitivity, integrity, confidence, transformations, derived_from, taint, expiry, allowed_use
```
...
Each protocol ships adversarial test vectors in `testvectors/P3/`:
