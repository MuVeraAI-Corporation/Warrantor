...
```
record_id, owner, confidence, contradiction_links, provenance, quarantine_state, supersession, retention, consent_revocation
```
...
Each protocol ships adversarial test vectors in `testvectors/P4/`:
