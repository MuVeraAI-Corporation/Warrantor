...
```
corpus_digest, environment, model_version, harness_version, policy_version, seeds, traces, judge_version, deterministic_assertions, signed_result
```
...
Each protocol ships adversarial test vectors in `testvectors/P8/`:
