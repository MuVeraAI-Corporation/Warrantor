...
| **Schema location** | `proto/aumos/protocols/v1/aar.proto + CDDL` |
...
The normative schema lives at `proto/aumos/protocols/v1/aar.proto + CDDL`. Mandatory fields:

```
actor, authority_hash, artifact_versions, context_commitment, policy_decision, tool_or_api_op, deterministic_checks, approver, outcome, rollback_pointer
```
...
Each protocol ships adversarial test vectors in `testvectors/P2/`:
