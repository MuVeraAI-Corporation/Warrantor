...
```
instructions, code, tools, permissions, publisher_identity, oms_signature, ai_sbom, eval_set, benchmark, limitations, revocation
```
...
Each protocol ships adversarial test vectors in `testvectors/P5/`:
