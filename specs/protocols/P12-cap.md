# P12 — Capability Attestation Profile

> Declare and verify what an agent can actually do in a specific runtime: tools, policy, credentials, network, memory, model, sandbox.
