...
```
steps, wall_clock, tokens, money, external_calls, data_volume, privilege, irreversible_actions, expected_risk
```
...
Each protocol ships adversarial test vectors in `testvectors/P7/`:
