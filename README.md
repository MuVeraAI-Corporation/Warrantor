...
- **Most of the Rust workspace is not wired into anything a user can run.** 9 of 39 crates
  link into the `warrantor` binary (`evidence/wiring-coverage.json` names the other 30). Many are
