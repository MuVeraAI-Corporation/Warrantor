...
'guard-0.6b-expguard-weak@T1-C-mlp' for lane 'modal-a100'.
...
Recipe digest: sha256:bd14328c2fb08f6b11cd8ac4a8c2b42a37537d65023289311031f29dd6d9cf69
"""
...
RUN_MANIFEST = json.loads(
    """{
    "recipe_id": "guard-0.6b-expguard-weak@T1-C-mlp",
    "recipe_digest": "sha256:bd14328c2fb08f6b11cd8ac4a8c2b42a37537d65023289311031f29dd6d9cf69",
    "lane": "modal-a100",
    "precision": "bf16",
...
if modal is not None:
    ...
    APP = modal.App("warrantor-guard-0.6b-expguard-weak@T1-C-mlp")
    ...
    def train_remote(corpus_bytes: bytes, run_id: str) -> dict:
        ...
        output = ADAPTER_ROOT / "guard-0.6b-expguard-weak@T1-C-mlp" / run_id
