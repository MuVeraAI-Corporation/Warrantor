...
'guard-0.6b-expguard-weak@T1-A-control' for lane 'modal-a100'.
...
Recipe digest: sha256:5a39936c14263b01f8235d98dc91c6474eb6ce0c69e73ae818420502c9d31b83
"""
...
RUN_MANIFEST = json.loads(
    """{
    "recipe_id": "guard-0.6b-expguard-weak@T1-A-control",
    "recipe_digest": "sha256:5a39936c14263b01f8235d98dc91c6474eb6ce0c69e73ae818420502c9d31b83",
    "lane": "modal-a100",
    "precision": "bf16",
...
if modal is not None:
    ...
    APP = modal.App("warrantor-guard-0.6b-expguard-weak@T1-A-control")
    ...
    def train_remote(corpus_bytes: bytes, run_id: str) -> dict:
        ...
        output = ADAPTER_ROOT / "guard-0.6b-expguard-weak@T1-A-control" / run_id
