# Task 01-setup — C1-1 nvtrust-bridge

> **Crate/package skeleton, CI, smoke test**. Acceptance criteria below.

## Objective

Crate/package skeleton, CI, smoke test for C1-1 nvtrust-bridge.
