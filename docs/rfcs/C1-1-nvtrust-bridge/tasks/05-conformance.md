# Task 05-conformance — C1-1 nvtrust-bridge

> **Cross-language golden vectors pass in every present language**. Acceptance criteria below.

## Objective

Cross-language golden vectors pass in every present language for C1-1 nvtrust-bridge.

## Steps

1. Implement per the RFC [`docs/rfcs/C1-1-nvtrust-bridge.md`](../../C1-1-nvtrust-bridge.md).
...
4. Add at least one golden vector in `testvectors/C1-1/`.
