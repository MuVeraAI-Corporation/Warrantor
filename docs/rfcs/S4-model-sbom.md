...
| **DefStack origin** | C4.1 ModelSBOM |
...
DefStack C4.1 ModelSBOM; AumSecure agent-bom-tools (V3 ext #6) + AI Artifact Trust Hub (V2 #7); Sentinel FORGE-SBOM (overlaps). The full strategic rationale
