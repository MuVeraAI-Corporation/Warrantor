...
Implementation language(s): Rust + WASM (Wasmtime). The component consumes the contract plane
...
**Dependency note:** where R8 depends on a Wave-2+ component not yet shipped (e.g. I1
...
- **Golden vectors:** `testvectors/R8/` — exercised by the cross-language conformance suite (A6).
