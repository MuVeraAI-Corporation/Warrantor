...
Implementation language(s): Rust (clap). The component consumes the contract plane
...
**Dependency note:** where X1 depends on a Wave-2+ component not yet shipped (e.g. I1
...
- **Golden vectors:** `testvectors/X1/` — exercised by the cross-language conformance suite (A6).
