# X11 — `defstack-cloud` RFC

> Managed SaaS surface. Per-tenant ZTAI isolation. Usage-based pricing. BSL/source-available.
...
| **Name** | defstack-cloud |
| **Wave** | 7 |
| **Languages** | Go control + TS console |
| **Warrantor origin** | (none) |
| **AumSecure origin** | (none) |
| **Sentinel origin** | sentinelos-cloud |
| **Dependencies** | all |
...
Warrantor (none); AumSecure (none); Sentinel sentinelos-cloud. The full strategic rationale
appears in the matrix entry and the originating source document (see
[`source-matrix/README.md`](../source-matrix/README.md)).

## Goals and Non-Goals

**Goals:** Managed SaaS surface. Per-tenant ZTAI isolation. Usage-based pricing. BSL/source-available.
...
Implementation language(s): Go control + TS console. The component consumes the contract plane
...
**Dependency note:** where X11 depends on a Wave-2+ component not yet shipped (e.g. I1
...
- **Golden vectors:** `testvectors/X11/` — exercised by the cross-language conformance suite (A6).
