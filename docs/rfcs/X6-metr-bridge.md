...
(`proto/`, `specs/`, `testvectors/`) and depends on: X2, A1.
...
**Dependency note:** where X6 depends on a Wave-2+ component not yet shipped (e.g. I1
...
- **Golden vectors:** `testvectors/X6/` — exercised by the cross-language conformance suite (A6).
