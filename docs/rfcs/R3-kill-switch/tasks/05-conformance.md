# Task 05-conformance — R3 kill-switch

> **Cross-language golden vectors pass in every present language**. Acceptance criteria below.

## Objective

Cross-language golden vectors pass in every present language for R3 kill-switch.

## Steps

1. Implement per the RFC [`docs/rfcs/R3-kill-switch.md`](../../R3-kill-switch.md).
...
4. Add at least one golden vector in `testvectors/R3/`.
