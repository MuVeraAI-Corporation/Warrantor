...
[GuardMeaning]. Companion work measured the *direction* of that sensitivity and found it
...
fixed seeds but do not verify semantic preservation, which is the same unperformed check Companion work already owes.
