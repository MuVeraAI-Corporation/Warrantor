...
Usage:
    from aumos_langchain import AumOSCallback, AumOSTool, wrap_agent
...
# ---------------------------------------------------------------------------
# Secret scanning (subset of aumos_harness patterns)
# ---------------------------------------------------------------------------
...
class AumOSCallback(_LCBase):
    ...
    def on_tool_end(
        self, output: str, *, run_id: str | None = None, **kwargs: Any
    ) -> Any:
...
class PermissionDenied(Exception):
    ...
    def __init__(self, identity: str, permission: str) -> None:
        ...
        super().__init__(
            f"Permission denied: {identity!r} lacks permission {permission!r}"
        )
