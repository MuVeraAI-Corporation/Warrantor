...
'guard-0.6b-expguard-weak' for lane 'modal-a100'.
...
Recipe digest: sha256:c8b5c7440ec12ac8e93f33ea6e4f637956e11e60fc6867bcdf332606b3aeb901
"""
...
RUN_MANIFEST = json.loads(
    """{
    "recipe_id": "guard-0.6b-expguard-weak",
    "recipe_digest": "sha256:c8b5c7440ec12ac8e93f33ea6e4f637956e11e60fc6867bcdf332606b3aeb901",
    "lane": "modal-a100",
    "precision": "bf16",
...
if modal is not None:
    ...
    APP = modal.App("warrantor-guard-0.6b-expguard-weak")
    ...
    def train_remote(corpus_bytes: bytes, run_id: str) -> dict:
        ...
        output = ADAPTER_ROOT / "guard-0.6b-expguard-weak" / run_id
        if output.exists():
            raise SystemExit(
                f"refusing to train: {output} already exists on the volume. Pick a new "
