...
'guard-4b-adversarial' for lane 'modal-a100'.
...
Recipe digest: sha256:0c9c863be0130c9367d7943c1d1c8da8220cdeb9b40ba7235eba5883f0e5d3d0
"""
...
RUN_MANIFEST = json.loads(
    """{
    "recipe_id": "guard-4b-adversarial",
    "recipe_digest": "sha256:0c9c863be0130c9367d7943c1d1c8da8220cdeb9b40ba7235eba5883f0e5d3d0",
    "lane": "modal-a100",
    "precision": "bf16",
...
if modal is not None:
    ...
    APP = modal.App("warrantor-guard-4b-adversarial")
    ...
    def train_remote(corpus_bytes: bytes, run_id: str) -> dict:
        ...
        output = ADAPTER_ROOT / "guard-4b-adversarial" / run_id
        if output.exists():
            raise SystemExit(
