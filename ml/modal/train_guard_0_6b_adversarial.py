...
'guard-0.6b-adversarial' for lane 'modal-a100'.
...
Recipe digest: sha256:a8abac6c2570305076b7a8375f50b2338719abdb3faab531257a7254bb2cffc8
"""
...
RUN_MANIFEST = json.loads(
    """{
    "recipe_id": "guard-0.6b-adversarial",
    "recipe_digest": "sha256:a8abac6c2570305076b7a8375f50b2338719abdb3faab531257a7254bb2cffc8",
    "lane": "modal-a100",
    "precision": "bf16",
...
if modal is not None:
    ...
    APP = modal.App("warrantor-guard-0.6b-adversarial")
    ...
    def train_remote(corpus_bytes: bytes, run_id: str) -> dict:
        ...
        output = ADAPTER_ROOT / "guard-0.6b-adversarial" / run_id
        if output.exists():
            raise SystemExit(
